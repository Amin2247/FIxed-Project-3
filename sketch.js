...
let greenValue = 128;
let blueValue = 128;
let s1 = "Type in ellipse, square or rectangle in the input box";
let s2 = "The program draws the shape on a different background";
...
function preload(){
  ...
  bg2 = loadImage('assets/image2.jpg');
  bg3 = loadImage('assets/image3.jpg');
  bg4 = loadImage('assets/image4.jpg');
  ...
  if (buttonPressed == true) {
    ...
    switch (selection) {
      ...
      case "ellipse":
        push();
        textSize(18);
        text("you have a ellipse",50,500)
        translate(centerX, centerY);
        rotate(angle);
        rectMode(CENTER);
        ellipse(0, 0, 150 + j, 100 + j);
      ...
      case "rectangle":
        push();
        textSize(18);
        text("you have a rectangle",50,500)
        translate(centerX, centerY);
        rotate(angle);
        rectMode(CENTER);
